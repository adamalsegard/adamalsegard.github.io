...
"records": [
  	{
	  "title":"Trygga", 
    "description": "Trygga is a service for a safer community, essentially a system for a smart panic alarm. The basic idea is to have a small device on you, as when triggered sends out a signal to a network of people in the nearby area who can interact if needed. The prototype was built with LittleBits, IFFT and meteor.js. The project was an entry at East Sweden Hack 2015 which is a hackathon at Mjärdevi Science park in Linköping. Trygga won the main price for Best Project. The price itself was a journey to Berlin in late 2015 to meet Start-ups and a couple of Internet-of-things companies (Industry 4.0). The team has continued to work on Trygga after the Hackathon (see our official website to the right for further information).",
    "skills": "teamwork, project management, work under pressure, meteor.js, presentation",
  ...
  {
	  "title":"Reverbify", 
    "description": "Reverbify is an application where the user can upload, record or choose a default sound that can be 'reverbified'. To 'reverbify' is to add a room's reverb to the chosen sound and then play it as it would sound in that room. This was a short group project in the course Sound Physics (TFYA65). The group of three put in a lot of more work than necessary for this type of project because we wanted to build a good application.",
  	"skills": "meteor.js, Web Audio API, bootstrap, Ionic",
...

  {
    ...
    "description": "The very website you are looking at right now. This is my first attempt at a fully functional website, all by myself.",
      ...
      
  {
    ...
    "description": "I studied at a film school i Stockholm for a year and did some short films. A couple of them can be seen in my different channels. I have also done some films in later years. Be sure to check out 'appearances' as well.",
